...
|         {G}[+] ᴅᴇᴠᴇʟᴏᴘᴇʀ : {B} Telegram Ruinz Checker                 |
|         {G}[+] ɢɪᴛʜᴜʙ ᴜsᴇʀɴᴀᴍᴇ   : {B}RuinzChecker       |
|         {G}[+] ᴛᴇʟᴇɢʀᴀᴍ ᴜsᴇʀɴᴀᴍᴇ : {B}@ruinzchecker     |
|         {G}[+] ᴛᴇʟᴇɢʀᴀᴍ ᴄʜᴀɴɴᴇʟ  : {B}https://t.me/ruinzscp   |
{E}=====================================================''')
def tui():
    while True:
    
        print(f'''{B}[ ᴅᴀᴛᴀ ]: {G}{channel.capitalize()}/{post}
{B}[ ʟɪᴠᴇ ᴠɪᴇᴡs ]: {G}{real_views} ❤️
